#!/usr/bin/env bash
# =============================================================================
# Actual Budget LXC Container Creation Script (Optimised)
# =============================================================================
...
# =============================================================================
# 
# This script creates an LXC container running Actual Budget on Proxmox VE.
# 
# Usage:
#   bash -c "$(curl -fsSL https://your-repo/ct/actualbudget.sh)"
#
# Features:
#   - Custom MOTD with IP:Port display on console login
#   - Optimised Node.js setup with Node 22 LTS
...
echo -e "${TAB}${GATEWAY}${BGN}http://${IP}:${ACTUAL_PORT}${CL}"
